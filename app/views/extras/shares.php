...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-xl-8 col-lg-8 col-md-10 col-11 text-center">
                ...
                <div class="row cards">
                    ...
                    <div class="card <?= $_COOKIE['lights'] == 1 ? "box-shadow" : ""; ?> mt-2 mb-2 share-acc-<?= $i ?>">
                        <div class="row">
                            ...
                            <div class="col-sm-5 col-5">
                                <h6><?= $accountInstance->getNameAccount($row['id']); ?></h6>
                            </div>
                            ...
                            <div class="col-1">
                                <a href="#" id="icon-a" data-bs-toggle="modal" data-bs-target="#delete-modal-account"
                ...
                <div class="row cards">
                    ...
                    ?>
                    <div
                        class="card <?= $_COOKIE['lights'] == 1 ? "box-shadow" : ""; ?> mt-2 mb-2 share-obj-<?= $i; ?>">
                        <div class="row">
                            <?php
                                    $userResult = get_user($conn, $row["user_id"]);
                                    while ($userSend = $userResult->fetch_assoc()) {
                            ...
                            <div class="col-1"> <a href="#" id="icon-a" data-bs-toggle="modal"
                                    ...
                                    onclick="modalObjective(<?= $row['id'] ?>,<?= $i ?>, <?= $row['user_id'] ?>)"><svg
                                        class="bi bi-2">
                                        <use id="icon-result" xlink:href="#delete" />
                                    </svg></a></div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-1">
                                <a href="#" id="icon-a" data-bs-toggle="modal"
                                    data-bs-target="#delete-modal-financial-goal"
    ...
    <div class="modal fade" id="delete-modal-financial-goal" tabindex="-1" aria-labelledby="delete-modalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
