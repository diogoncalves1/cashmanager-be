...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div
        ...
        <h1 class="h2"><?= $translate["add_financial_goal"]; ?></h1>
            ...
            <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                ...
                <div class="row justify-content-between text-left">
                    <div class="form-group col-sm-6 flex-column d-flex">
                        ...
                        <input onchange="verifyDate()" type="date" min="<?= $currentDate; ?>" id="initial-date"
                    ...
                    <div class="form-group col-sm-6 flex-column d-flex">
                        ...
                        <input onchange="verifyDate()" type="date" min="<?= $currentDate; ?>" id="final-date"
                ...
                <div class="row justify-content-between text-left">
                    <div class="form-group col-sm-6 flex-column d-flex">
                        <label class="form-control-label px-3"><?= $translate["status"]; ?>
                            <span class="text-danger-emphasis"> *</span>
                        </label>
                ...
                <div class="row justify-content-end">
                    <div class="form-group col-sm-6">
                        <button type="submit" id="submit-btn"
                            class="button btn btn-sm btn-outline-danger"><?= $translate["add_financial_goal"]; ?></button>
                    </div>
                </div>
            </div>
        </div>
...
<script src="../public/assets/js/financial-goals/add-financial-goal.js"></script>