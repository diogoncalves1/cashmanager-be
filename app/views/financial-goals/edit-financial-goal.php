                            ...
                            <div class="row justify-content-between text-left">
                                <div class="form-group col-sm-6 flex-column d-flex">
                                    ...
                                    <input type="number" class="input" step="0.01" min="0.01" id="input-value"
                                        name="value" value="<?= $row['value']; ?>" placeholder="0.00<?= $coin; ?>" required>
                                </div>
                                <div class="form-group col-sm-6 flex-column d-flex">
                            ...
                            <div class="row justify-content-between text-left">
                                <div class="form-group col-sm-6 flex-column d-flex">
                                    ...
                                    <input onchange="verifyDate()" type="date" min="<?= $curDate; ?>"
                                        id="initial-date" class="input" max="<?= $row['final_date']; ?>" value="<?= $row['start_date']; ?>" name="start_date" required>
                                </div>
                                <div class="form-group col-sm-6 flex-column d-flex">
                                    <label class="form-control-label px-3"><?php echo $final_date_translate; ?>
                                        <span class="text-danger-emphasis"> *</span>
                                    </label>
                                    <input onchange="verifyDate()" type="date" min="<?= $row['start_date']; ?>"
                                        id="final-date" class="input" value="<?= $row['final_date']; ?>" name="final_date" required>
                                </div>
                            </div>
                            <div class="row justify-content-between text-left">
                                <div class="form-group col-sm-12 flex-column d-flex"> <label
                                    ...
                                    <select name="category" required>
                                        ...
                                        while ($roWW = mysqli_fetch_assoc($result_cats)) { ?>
                                            <option value="<?php echo $roWW['id']; ?>" <?php if ($roWW['id'] == $row['cat_id'])
                                                                                            echo "selected"; ?>><?php if ($_COOKIE['lang'] == "EN")
                                                                                                                    echo $roWW['name'];
                                                                                                                else
                            ...
                            <div class="row justify-content-between text-left">
                                ...
                                <div class="form-group col-sm-6 flex-column d-flex"> <label
                                    ...
                                    <select name="priority" required>
                                        ...
                                        while ($roWW = mysqli_fetch_assoc($result_priority)) { ?>
                                            <option value="<?php echo $roWW['id']; ?>" <?php if ($roWW['id'] == $row['priority_id'])
                                                                                            echo "selected"; ?>><?php if ($_COOKIE['lang'] == "EN")
                                                                                                                    echo $roWW['name'];
                                                                                                                else
                                                                                                                    echo $roWW['name_pt']; ?></option>
