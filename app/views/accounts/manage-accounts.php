...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div
        ...
        <h1 class="h2"><?= $translate["accounts"]; ?></h1>
    ...
    <button class="btn btn-outline-primary mb-4" id="add-account"><?= $translate["create_account"]; ?></button>
    <?php if ($userAccounts) { ?>
        <div class="table-responsive center">
            <table class="table table-bordered border align-middle text-center">
                <thead>
                    <tr>
                        <th scope="col" class="col-6"><?= $translate["name"]; ?></th>
                ...
                <tbody id="table">
                    ...
                    foreach ($userAccounts as $account) {
                        if (hasPerm($account["role_id"], "view_accounts")) { ?>
                            <tr id="tr-<?= $account['id'] ?>"
                                class="<?php if ($_COOKIE['mode'] == "light") { ?>table-primary <?php } ?>primary">
                                <td><?= $account['name']; ?></td>
                                <td><?= $account['cash']; ?><?= $userCoin; ?></td>
                                <td>
                                    ...
                                    <?php if (hasPerm($account["role_id"], "edit_account")) { ?>
                                    ...
                                    <?php } ?>
                                    <?php if (hasPerm($account["role_id"], "delete_account")) { ?>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="delete-modalLabel"><?= $translate["delete"]; ?></h1>
                ...
                <div class="modal-body text-center">
                    ...
                    <h6 class="mb-4"><?= $modal_acc2; ?></h4>
                        <button type="button" id="modal-btn" data-bs-dismiss="modal"
                            class="btn btn-success btn-lg me-2 liveToastBtn"><?= $translate["confirm"]; ?></button>
                        <button type="button" class="btn btn-danger btn-lg "
                            data-bs-dismiss="modal"><?= $translate["decline"]; ?></button>
                </div>
            </div>
        </div>
    </div>
