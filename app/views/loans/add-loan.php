...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div
        ...
        <h1 class="h2"><?php echo $add_loan; ?></h1>
                ...
                <form class="form-card" method="POST">
                    <div class="row justify-content-between text-left">
                        <div class="form-group col-sm-6 flex-column d-flex">
                            <label class="form-control-label px-3"><?= $financial_institution; ?>
                                <span class="text-danger-emphasis"> *</span>
                            </label>
                            <input type="text" id="lname" placeholder="<?= $financial_institution ?>..." class="input" name="institution" required>
                        </div>
                        <div class="form-group col-sm-6 flex-column d-flex">
                            <label class="form-control-label px-3"><?= $amount_borrowed; ?>
                                <span class="text-danger-emphasis"> *</span>
                            </label>
