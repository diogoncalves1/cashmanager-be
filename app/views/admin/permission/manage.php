...
if (is_admin($conn, $user_id)) {
    ...
    $_SESSION['page'] = "manage permissions";
...
?>
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div
            ...
            <h1 class="h2"><?php echo $words[$_COOKIE["lang"]]["permissions"]; ?></h1>
        </div>

        <button class="btn btn-outline-primary mb-4" onclick="goToAdd()">
            <?= $words[$_COOKIE["lang"]]["add_permission"] ?>
        </button>
                    ...
                    foreach ($permissions as $permission) { ?>
                        <tr id="category-<?= $permission['id'] ?>"
                            ...
                            <td class="center"><button data-bs-toggle="modal" data-bs-target="#delete-modal"
                                    ...
                                    onclick="updateModal(<?php echo $permission['id']; ?>)">
                                    <svg class="bi">
    ...
    <script src="/CashManager/public/assets/admin/js/permissions.js"></script>
<?php } ?>