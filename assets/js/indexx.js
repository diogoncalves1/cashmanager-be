...
function goToExpense() {
  window.location.href = "/CashManager/public/transactions/add/expense";
}
function goToRevenue() {
  window.location.href = "/CashManager/public/transactions/add/revenue";
}
...
function goToManageTransactions(type) {
  window.location.href = "/CashManager/public/transactions?type=" + type;
}

function goToviewTransaction(id) {
  window.location.href = "/CashManager/public/transactions/view?i=" + id;
}