...
@section('title', (isset($emailLayout) ? 'Editar' : 'Adicionar') . ' Layout de Email')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="col-md-12 ">
                            <form role="form"
                                action="{{ route('admin.settings.emailLayouts.update', [$emailType->id]) }}"
                                        ...
                                        <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill"
                                                    ...
                                                    aria-controls="custom-tabs-one-home" aria-selected="true">Email</a>
                                            </li>
                                            <li class="nav-item">
                                            ...
                                            <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel"
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                                                        ...
                                                        <textarea class="form-control" rows="6" name="email" placeholder="Email" id="email">{{ old('email') ?: (isset($emailLayout) ? $emailLayout->email : '') }}</textarea>
                                                        @if ($errors->has('email'))
                                                            <span class="help-block">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div
                                                        class="form-group {{ $errors->has('signature') ? ' has-error' : '' }}">
                                                        <label for="email">
                                                            <span class="text-danger">*</span>
                                                            Assinatura
                                                        </label>
                                                        <textarea class="form-control" name="signature" id="signature" placeholder="Assinatura">{{ old('signature') ?: (isset($emailLayout) ? $emailLayout->signature : '') }}</textarea>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <span class="input-group-btn">
                                                                <span class="btn btn-default btn-file"><span><i
                                                                            class="fa fa-folder-open mr-2">
