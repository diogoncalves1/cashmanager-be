...
@section('title', (isset($emailType) ? 'Editar' : 'Adicionar') . ' Tipo de Email')
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        @if (!isset($emailType))
                            ...
                            @else
                                <form role="form" action="{{ route('admin.emailTypes.update', [$emailType->id]) }}"
                                    method="post">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group" style="width: 100%;">
                                            <select class="form-control select2" multiple="multiple" style="width: 100%;"
                                                id="keywords-select" name="keywords[]">
                                                @if (isset($emailType))
                                ...
                                <div class="col-md-12">
                                    <div class="form-group  {{ $errors->has('descriptions') ? ' has-error' : '' }}">
                                        ...
                                        <div class="input-group" style="width: 100%;">
                                            <select class="form-control select2" multiple="multiple" style="width: 100%;"
                                                id="descriptions-select" name="descriptions[]">
                                                @if (isset($emailType))
                                                    @foreach ($emailType->keywords as $keyword)
