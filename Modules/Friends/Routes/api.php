        ...
        Route::group(
            ...
            function () {
                ...
                Route::group([
                    ...
                    Route::delete('{id}/cancel', [FriendshipRequestController::class, 'cancel'])->name('cancel');
                    Route::get('sent', [FriendshipRequestController::class, 'listSent']);
                    Route::get('received', [FriendshipRequestController::class, 'listReceived']);
                });
            }
        );
    }
